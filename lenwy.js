  ...
  try {
    ...
    const onlygc = () => {
      ...
      lenwy.sendMessage(
        m.chat,
        {
          audio: fs.readFileSync("./mp3/private.mp3"),
          mimetype: "audio/mp4",
          ptt: true,
          fileLength: 88738,
        },
      ...
      case "listdmff":
        {
          ...
          let filennya = "";
          try {
            filennya = fs.readFileSync("./fflist.txt", "utf8");
          } catch (error) {
      ...
      case "listdmml":
        {
          ...
          let filennya = "";
          try {
            filennya = fs.readFileSync("./mllist.txt", "utf8");
          } catch (error) {
            console.error("Error saat membaca file:", error);
            return reply("Maaf, terjadi kesalahan saat membaca file.");
          }
      ...
      case "listucpubg":
        {
          ...
          let filennya = "";
          try {
            filennya = fs.readFileSync("./pubglist.txt", "utf8");
          } catch (error) {
            console.error("Error saat membaca file:", error);
            return reply("Maaf, terjadi kesalahan saat membaca file.");
          }
