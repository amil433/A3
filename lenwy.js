...
klik https://wa.me/${Number.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
...
let xmenu_oh = `p juga`
lenwy.sendMessage(m.chat, {
                        image: fs.readFileSync('./data/image/thumbs.jpg'),
                        caption: xmenu_oh}, { quoted: m})
                        }
                        break
...
_Bot Wa Yang Dirancang Khusus Untuk Membantu Owner Jualan Jika Kalian Gabut Aku bisa Menemani Atau Membantu Kamu Dalam Berbagai Hal_
...
`
lenwy.sendMessage(m.chat, { image: ppnyauser, caption: xmenu_oh}, {quoted:m})
}
break
case'allmenu':{
if (isBan) return reply('*Kamu Di Ban Owner*')
...
case 'ask': {
                ...
                if (q.toLowerCase().includes("siapa kamu")) {
                  return reply('Saya Adalah bot yang di buat dan di integrasikan melalui OpenAI oleh YUDDZ');
              }              
                reply('🍞 *Sabar Yaa*')
...
if (args[0].startsWith(`+6282287486762`)) return reply('Tidak bisa call ke nomor ini!')
...
console.log(util.format(err))
let e = String(err)
lenwy.sendMessage('6282287486762' + "@s.whatsapp.net", { text: `*Hai Owner, Ada Yang Error Nih! Di Bagian :* ` + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
