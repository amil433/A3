...
console.log(color(figlet.textSync("NS-BOT", {
font: 'Standard',
...
if (anu.action == 'add') {
let a = `🍞 *Selamat Datang Di* ${metadata.subject} ${num.split("@")[0]}`
...
let b = `🍞 Selamat Tinggal ${num.split("@")[0]}`
lenwy.sendMessage(anu.id, {
     text: b, 
      contextInfo: {
         externalAdReply: {
...
connectToWhatsApp();
  ...
  lenwy.sendMessage('6288294744259' + "@s.whatsapp.net", { text: `🍞 *Pembaruan*\n\n🍁 *NS-BOT Sukses Terhubung*\n\n🎁 *Author : wa.me/6288294744259*` });
}
